...
- Uživatel chce stejný styl dokumentace a komentářů napříč všemi třídami: konzistentní XML dokumentace nad funkcemi i proměnnými a jen stručné, smysluplné komentáře v těle kódu. Komentáře by měly přesně odpovídat aktuální implementaci (po změně logiky upravit i XML komentáře).
